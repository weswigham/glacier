export declare type ReduxStandardAction<T extends string, P> = {
    type: T;
    payload: P;
    error?: Error;
};
...
export declare type AllActions = AddDataSourceAction<string, {}, {}> | RemoveDataSourceAction | UpdateDataCacheAction<{}> | UpdateDescriptionAction | UpdateMarkTypeAction | UpdateSizeAction | AddFieldsAction | RemoveFieldsAction | RemoveFieldsByIdAction | AddJoinAction | RemoveJoinAction | AddChannelAction<Channel> | RemoveChannelAction<Channel> | UpdateChannelAction<Channel> | SetFilterAction;
